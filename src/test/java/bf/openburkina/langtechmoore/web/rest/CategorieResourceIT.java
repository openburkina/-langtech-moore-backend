...
class CategorieResourceIT {
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie().libelle(DEFAULT_LIBELLE).description(DEFAULT_DESCRIPTION);
        return categorie;
    }
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie().libelle(UPDATED_LIBELLE).description(UPDATED_DESCRIPTION);
        return categorie;
    }
    ...
    void putNewCategorie() throws Exception {
        ...
        updatedCategorie.libelle(UPDATED_LIBELLE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateCategorieWithPatch() throws Exception {
        ...
        partialUpdatedCategorie.libelle(UPDATED_LIBELLE).description(UPDATED_DESCRIPTION);
